...
public class ArchitectureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ArchitecturePackage.CLASS: {
				icmt.tool.momot.demo.architectureCRA.Class class_ = (icmt.tool.momot.demo.architectureCRA.Class)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(icmt.tool.momot.demo.architectureCRA.Class object) {
		return null;
	}
