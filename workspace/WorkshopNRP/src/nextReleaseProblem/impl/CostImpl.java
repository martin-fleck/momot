 ...
 * </p>
 * <ul>
 *   <li>{@link nextReleaseProblem.impl.CostImpl#getType <em>Type</em>}</li>
 *   <li>{@link nextReleaseProblem.impl.CostImpl#getAmount <em>Amount</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CostImpl extends MinimalEObjectImpl.Container implements Cost {
	...
	protected EClass eStaticClass() {
		return NextReleaseProblemPackage.Literals.COST;
	}
	...
	public void setType(CostType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NextReleaseProblemPackage.COST__TYPE, oldType, type));
	}
	...
	public void setAmount(double newAmount) {
		...
		amount = newAmount;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NextReleaseProblemPackage.COST__AMOUNT, oldAmount, amount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NextReleaseProblemPackage.COST__TYPE:
				return getType();
			case NextReleaseProblemPackage.COST__AMOUNT:
				return getAmount();
		}
