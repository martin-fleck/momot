...
class MaximiseSatisfaction extends AbstractModelQueryFitnessFunction {
	 ...
	 * other requirements.
	 */
	def static Double calculateSatisfaction(EObject customer) {
	 ...
	 */
	def static Double calculateFulfillment(EObject requirement, EObject customer) {
	 ...
	 * customer.
	 */	
	def static Iterable<EObject> getDependencyValuations(EObject requirement, EObject customer) {
	 ...
	 */	
	def static Iterable<EObject> selectMaximalValuations(Iterable<EObject> valuations) {
	 ...
	 */
	def static Double calcOverallFulfillmentContribution(Iterable<EObject> valuations, EObject customer) {
	 ...
	 * realisation directly or indirectly depends on are selected in the solution. 
 	 */
	def static isImplemented(EObject realisation) {
	...
	def static isSelected(EObject softwareArtifact) {
