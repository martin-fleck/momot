...
public class ConstraintSearch {
	...
	private static final String INPUT_MODEL = "router/router.xmi";
	private static final String INPUT_META_MODEL = "router/router.ecore";
...
//	private static final String REFERENCE_SET = "model/input/referenceSet/model_five_stacks_reference_set.pf";
	...
	public static void main(String[] args) throws IOException {
		...
		StackOrchestration search = new StackOrchestration(provider, INPUT_MODEL, SOLUTION_LENGTH);
		
		search.registerMetamodel(INPUT_META_MODEL);
