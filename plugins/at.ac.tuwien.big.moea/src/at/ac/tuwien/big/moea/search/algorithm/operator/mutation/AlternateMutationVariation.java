...
public class AlternateMutationVariation extends AbstractMutationVariation {

   private final List<IProbabilityVariation> operators;

   private final double replaceWithPlaceholderProbability;

   public AlternateMutationVariation(final double probability, final double replaceWithPlaceholderProbability) {
      this(probability, replaceWithPlaceholderProbability, new IProbabilityVariation[] {});
   }
   ...
   public AlternateMutationVariation addOperator(final IProbabilityVariation operator) {
