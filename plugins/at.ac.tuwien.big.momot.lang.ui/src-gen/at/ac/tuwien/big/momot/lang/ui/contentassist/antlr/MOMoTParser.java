		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExperimentOrchestrationAccess().getGroup_8(), "rule__ExperimentOrchestration__Group_8__0");
					...
					put(grammarAccess.getExperimentOrchestrationAccess().getGroup_13_3_1(), "rule__ExperimentOrchestration__Group_13_3_1__0");
					put(grammarAccess.getExperimentOrchestrationAccess().getGroup_14(), "rule__ExperimentOrchestration__Group_14__0");
					put(grammarAccess.getExperimentOrchestrationAccess().getGroup_14_3(), "rule__ExperimentOrchestration__Group_14_3__0");
					put(grammarAccess.getExperimentOrchestrationAccess().getGroup_14_3_2(), "rule__ExperimentOrchestration__Group_14_3_2__0");
					...
					put(grammarAccess.getExperimentOrchestrationAccess().getMaxSecondsAssignment_8_2(), "rule__ExperimentOrchestration__MaxSecondsAssignment_8_2");
					put(grammarAccess.getExperimentOrchestrationAccess().getNrRunsAssignment_11(), "rule__ExperimentOrchestration__NrRunsAssignment_11");
					put(grammarAccess.getExperimentOrchestrationAccess().getReferenceSetAssignment_12_2(), "rule__ExperimentOrchestration__ReferenceSetAssignment_12_2");
					put(grammarAccess.getExperimentOrchestrationAccess().getProgressListenersAssignment_13_3_0(), "rule__ExperimentOrchestration__ProgressListenersAssignment_13_3_0");
					put(grammarAccess.getExperimentOrchestrationAccess().getProgressListenersAssignment_13_3_1_1(), "rule__ExperimentOrchestration__ProgressListenersAssignment_13_3_1_1");
					put(grammarAccess.getExperimentOrchestrationAccess().getCollectorsAssignment_14_3_0(), "rule__ExperimentOrchestration__CollectorsAssignment_14_3_0");
					put(grammarAccess.getExperimentOrchestrationAccess().getCustomCollectorsAssignment_14_3_1(), "rule__ExperimentOrchestration__CustomCollectorsAssignment_14_3_1");
					put(grammarAccess.getExperimentOrchestrationAccess().getCustomCollectorsAssignment_14_3_2_1(), "rule__ExperimentOrchestration__CustomCollectorsAssignment_14_3_2_1");
