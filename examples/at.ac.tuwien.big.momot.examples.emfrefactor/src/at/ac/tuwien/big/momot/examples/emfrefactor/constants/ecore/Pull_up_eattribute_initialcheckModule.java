...
public interface Pull_up_eattribute_initialcheckModule {
   ...
   public static interface Check_superEClass {
      static String NAME = Pull_up_eattribute_initialcheckModule.MODULE + Pull_up_eattribute_initialcheckModule.SEPARATOR + "check_superEClass";
      static interface Parameter {
         String SELECTED_E_ATTRIBUTE = Check_superEClass.NAME + Pull_up_eattribute_initialcheckModule.SEPARATOR + "selectedEAttribute";
      }
   }

   public static interface MainUnit {
      static String NAME = Pull_up_eattribute_initialcheckModule.MODULE + Pull_up_eattribute_initialcheckModule.SEPARATOR + "mainUnit";
      static interface Parameter {
