...
public class ModularizationAdapterFactory extends AdapterFactoryImpl {
	...
	protected ModularizationSwitch<Adapter> modelSwitch =
		new ModularizationSwitch<Adapter>() {
			...
			@Override
			public Adapter caseClass(at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.NamedElement <em>Named Element</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.ModularizationModel <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Module <em>Module</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class <em>Class</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
