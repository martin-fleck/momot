 ...
 * </p>
 * <ul>
 * <li>{@link at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.impl.ModuleImpl#getClasses
 * <em>Classes</em>}</li>
 * </ul>
 *
 * @generated
...
public class ModuleImpl extends NamedElementImpl implements Module {
   ...
   public EList<at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class> getClasses() {
      if(classes == null) {
         classes = new EObjectWithInverseResolvingEList<>(
               at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class.class, this,
               ModularizationPackage.MODULE__CLASSES, ModularizationPackage.CLASS__MODULE);
      }
      return classes;
   }

   protected int getPosition() {
      final ModularizationModel model = CastUtil.asClass(eContainer(), ModularizationModel.class);
      if(model != null) {
         return model.getModules().indexOf(this);
      }
      return -1;
   }
   ...
   // return prime * result + getPosition();
   // } else
