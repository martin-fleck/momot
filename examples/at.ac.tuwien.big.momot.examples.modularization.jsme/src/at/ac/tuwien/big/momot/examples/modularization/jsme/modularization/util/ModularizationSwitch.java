...
public class ModularizationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModularizationPackage.MODULARIZATION_MODEL: {
				ModularizationModel modularizationModel = (ModularizationModel)theEObject;
				T result = caseModularizationModel(modularizationModel);
				if (result == null) result = caseNamedElement(modularizationModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModularizationPackage.CLASS: {
				at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class class_ = (at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class)theEObject;
	 ...
	 * @generated
	 */
	public T caseModularizationModel(ModularizationModel object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class object) {
		return null;
	}
