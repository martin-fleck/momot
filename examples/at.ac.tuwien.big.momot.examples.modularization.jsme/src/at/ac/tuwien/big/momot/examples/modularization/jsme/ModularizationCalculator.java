...
public class ModularizationCalculator implements Serializable {
	...
	protected void calculate() {
		...
		for(at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class clazz : model.getClasses()) {
	...
	protected ModuleMetrics calculate(Module source) {
		...
		for(Module target : model.getModules()) {			
			...
			for(at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class sourceClazz : source.getClasses()) {
				for(at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class targetClazz : target.getClasses()) {
