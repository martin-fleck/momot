...
public class ModularizationInstances {
   ...
   public static ModelMetrics createHarmanMetrics() {
      final ModelMetrics metrics = new ModelMetrics();
      metrics.coupling = 6;
      metrics.cohesion = 6;
      metrics.nrModules = 3;
   ...
   public static ModularizationInstance createHarmanPaperInstance() {
      final ModularizationInstance instance = new ModularizationInstance();
   ...
   public static ModularizationInstance createMtunis() {
      final ModularizationInstance instance = new ModularizationInstance();
      instance.addClasses("File", "Panic", "State", "Family", "Directory", "main", "FileTable", "InodeGlobals", "Inode",
            "Tty", "User", "FileIO", "Device", "Disk", "FreeInode", "System", "Control", "InodeTable", "Computer",
            "Memory");
      instance.addDependencies("File", "System", "Inode", "Directory", "Panic", "FileTable");
      instance.addDependencies("Panic", "Directory", "File", "Inode", "Disk", "InodeTable", "FileIO", "InodeGlobals",
      ...
      instance.addDependencies("Inode", "Panic", "Device", "System", "InodeTable", "FreeInode", "FileIO",
            "InodeGlobals");
