...
public class ArchitectureAdapterFactory extends AdapterFactoryImpl {
	...
	protected ArchitectureSwitch<Adapter> modelSwitch =
		new ArchitectureSwitch<Adapter>() {
			...
			@Override
			public Adapter caseClass(icmt.tool.momot.demo.architecture.Class object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link icmt.tool.momot.demo.architecture.ClassModel <em>Class Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link icmt.tool.momot.demo.architecture.Attribute <em>Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link icmt.tool.momot.demo.architecture.NamedElement <em>Named Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
