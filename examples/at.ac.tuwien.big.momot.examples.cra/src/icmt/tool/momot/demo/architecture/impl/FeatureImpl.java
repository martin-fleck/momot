...
public abstract class FeatureImpl extends NamedElementImpl implements Feature {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIsEncapsulatedBy(icmt.tool.momot.demo.architecture.Class newIsEncapsulatedBy, NotificationChain msgs) {
		icmt.tool.momot.demo.architecture.Class oldIsEncapsulatedBy = isEncapsulatedBy;
	 ...
	 * @generated
	 */
	public void setIsEncapsulatedBy(icmt.tool.momot.demo.architecture.Class newIsEncapsulatedBy) {
		if (newIsEncapsulatedBy != isEncapsulatedBy) {
			NotificationChain msgs = null;
			if (isEncapsulatedBy != null)
				msgs = ((InternalEObject)isEncapsulatedBy).eInverseRemove(this, ArchitecturePackage.CLASS__ENCAPSULATES, icmt.tool.momot.demo.architecture.Class.class, msgs);
			if (newIsEncapsulatedBy != null)
				msgs = ((InternalEObject)newIsEncapsulatedBy).eInverseAdd(this, ArchitecturePackage.CLASS__ENCAPSULATES, icmt.tool.momot.demo.architecture.Class.class, msgs);
