 ...
 *   <li>{@link at.ac.tuwien.big.momot.examples.ecore.modularization.impl.RelationshipImpl#getRelationshipEnd <em>Relationship End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationshipImpl extends MinimalEObjectImpl.Container implements Relationship {
	...
	public void setWeight(int newWeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModularizationPackage.RELATIONSHIP__WEIGHT, oldWeight, weight));
	}
	...
	public Entity getRelationshipEnd() {
		if (relationshipEnd != null && relationshipEnd.eIsProxy()) {
			...
			if (relationshipEnd != oldRelationshipEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModularizationPackage.RELATIONSHIP__RELATIONSHIP_END, oldRelationshipEnd, relationshipEnd));
			}
		}
	 ...
	 * @generated
	 */
	public void setRelationshipEnd(Entity newRelationshipEnd) {
		Entity oldRelationshipEnd = relationshipEnd;
		relationshipEnd = newRelationshipEnd;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModularizationPackage.RELATIONSHIP__RELATIONSHIP_END, oldRelationshipEnd, relationshipEnd));
	}
