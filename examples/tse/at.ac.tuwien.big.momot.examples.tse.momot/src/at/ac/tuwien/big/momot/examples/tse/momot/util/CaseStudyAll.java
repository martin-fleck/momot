...
public class CaseStudyAll {
	...
	public interface OCL2R2ML {
		...
		public static final String OUTPUT_DIR = BASE_DIR + "OCL2R2ML/output/OCL2R2ML/momotAll/";
	}
	...
	public interface R2ML2XML {
		...
		public static final String OUTPUT_DIR = BASE_DIR + "OCL2R2ML/output/R2ML2XML/momotAll/";
	}
	...
	public interface RDM2R2ML {
		...
		public static final String OUTPUT_DIR = BASE_DIR + "RDM2R2ML/output/momotAll/";
	}
	...
	public interface XML2Ant {
		...
		public static final String OUTPUT_DIR = BASE_DIR + "XML2Ant/output/momotAll/";
	}
	...
	public interface XML2KML {
		...
		public static final String OUTPUT_DIR = BASE_DIR + "XML2KML/output/momotAll/";
	}
	...
	public interface XML2MySQL {
		...
		public static final String OUTPUT_DIR = BASE_DIR + "XML2MySQL/output/momotAll/";
	}
	...
	public interface JavaMethods2UMLActivityDiagram {
		...
		public static final String OUTPUT_DIR = BASE_DIR + "JavaMethods2UMLActivityDiagram/output/momotAll/";
	}
	...
	public interface Ecore2Maude {
		...
		public static final String OUTPUT_DIR = BASE_DIR + "Ecore2Maude/output/momotAll/";
	}
	...
	public interface XHTML2XML {
		...
		public static final String OUTPUT_DIR = BASE_DIR + "XHTML2XML/output/momotAll/";
	}
}
