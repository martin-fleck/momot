...
/**
 * Entry point of the 'DependenciesBuilder' transformation module.
 */
public class DependenciesBuilder {
	 ...
	 * @generated
	 */
	public DependenciesBuilder() throws IOException {
		properties = new Properties();
		properties.load(getFileURL("DependenciesBuilder.properties").openStream());
	 ...
	 * @generated
	 */
	public Object doDependenciesBuilder(IProgressMonitor monitor) throws ATLCoreException, IOException, ATLExecutionException {
	...
	protected InputStream[] getModulesList() throws IOException {
		...
		String modulesList = properties.getProperty("DependenciesBuilder.modules");
		if (modulesList != null) {
	...
	protected String getMetamodelUri(String metamodelName) {
		return properties.getProperty("DependenciesBuilder.metamodels." + metamodelName);
	}
	...
	protected InputStream getLibraryAsStream(String libraryName) throws IOException {
		return getFileURL(properties.getProperty("DependenciesBuilder.libraries." + libraryName)).openStream();
	}
	...
	protected Map<String, Object> getOptions() {
		...
		for (Entry<Object, Object> entry : properties.entrySet()) {
			if (entry.getKey().toString().startsWith("DependenciesBuilder.options.")) {
				options.put(entry.getKey().toString().replaceFirst("DependenciesBuilder.options.", ""), 
	...
	protected static URL getFileURL(String fileName) throws IOException {
		final URL fileURL;
		if (isEclipseRunning()) {
			URL resourceURL = DependenciesBuilder.class.getResource(fileName);
			if (resourceURL != null) {
			...
			fileURL = DependenciesBuilder.class.getResource(fileName);
		}
		if (fileURL == null) {
