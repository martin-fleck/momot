...
public class ModularizationJSEPSearchECA {
  ...
  public class ModularizationJSEPFitnessFunction extends EGraphMultiDimensionalFitnessFunction {
    ...
    protected void preprocessEvaluation(final TransformationSolution solution) {
      ...
      solution.setAttribute(ModularizationJSEPSearchECA.attribute, _modularizationCalculator);
    }
  }
  ...
  protected double _createObjectiveHelper_0(final TransformationSolution solution, final EObject root) {
    ...
    {
      final ModularizationCalculator calculator = solution.<ModularizationCalculator>getAttribute(ModularizationJSEPSearchECA.attribute, ModularizationCalculator.class);
  ...
  protected IEGraphMultiDimensionalFitnessFunction createFitnessFunction(final TransformationSearchOrchestration orchestration) {
    IEGraphMultiDimensionalFitnessFunction function = new ModularizationJSEPSearchECA.ModularizationJSEPFitnessFunction();
  ...
  protected SearchExperiment<TransformationSolution> createExperiment(final TransformationSearchOrchestration orchestration) {
    SearchExperiment<TransformationSolution> experiment = new SearchExperiment<>(orchestration, maxEvaluations);
  ...
  public static void main(final String... args) {
    init();
    for(int i = 0; i < 20; i++) {
    	ModularizationJSEPSearchECA search = new ModularizationJSEPSearchECA();
