 ...
 * </p>
 * <ul>
 *   <li>{@link at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.impl.ClassImpl#getModule <em>Module</em>}</li>
 *   <li>{@link at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.impl.ClassImpl#getDependsOn <em>Depends On</em>}</li>
 *   <li>{@link at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.impl.ClassImpl#getDependedOnBy <em>Depended On By</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassImpl extends NamedElementImpl implements at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class {
	/**
	...
	public EList<at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class> getDependsOn() {
		if (dependsOn == null) {
			dependsOn = new EObjectWithInverseResolvingEList.ManyInverse<at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class>(at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class.class, this, ModularizationPackage.CLASS__DEPENDS_ON, ModularizationPackage.CLASS__DEPENDED_ON_BY);
		}
		return dependsOn;
	}
	...
	public EList<at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class> getDependedOnBy() {
		if (dependedOnBy == null) {
			dependedOnBy = new EObjectWithInverseResolvingEList.ManyInverse<at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class>(at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class.class, this, ModularizationPackage.CLASS__DEPENDED_ON_BY, ModularizationPackage.CLASS__DEPENDS_ON);
		}
		return dependedOnBy;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModularizationPackage.CLASS__DEPENDS_ON:
				getDependsOn().clear();
				getDependsOn().addAll((Collection<? extends at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class>)newValue);
				return;
			case ModularizationPackage.CLASS__DEPENDED_ON_BY:
				getDependedOnBy().clear();
				getDependedOnBy().addAll((Collection<? extends at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class>)newValue);
				return;
		}
