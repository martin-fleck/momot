...
public class ArchitectureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ArchitecturePackage.CLASS: {
				icmt.tool.momot.demo.architecture.Class class_ = (icmt.tool.momot.demo.architecture.Class)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(icmt.tool.momot.demo.architecture.Class object) {
		return null;
	}
