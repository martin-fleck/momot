...
public class ArchitecturePackageImpl extends EPackageImpl implements ArchitecturePackage {
	...
	public void initializePackageContents() {
		...
		initEClass(classEClass, icmt.tool.momot.demo.architecture.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_Encapsulates(), this.getFeature(), this.getFeature_IsEncapsulatedBy(), "encapsulates", null, 1, -1, icmt.tool.momot.demo.architecture.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
