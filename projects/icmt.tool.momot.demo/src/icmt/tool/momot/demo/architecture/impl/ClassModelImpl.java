...
public class ClassModelImpl extends NamedElementImpl implements ClassModel {
	...
	public EList<icmt.tool.momot.demo.architecture.Class> getClasses() {
		if (classes == null) {
			classes = new EObjectContainmentEList<icmt.tool.momot.demo.architecture.Class>(icmt.tool.momot.demo.architecture.Class.class, this, ArchitecturePackage.CLASS_MODEL__CLASSES);
		}
		return classes;
	}
