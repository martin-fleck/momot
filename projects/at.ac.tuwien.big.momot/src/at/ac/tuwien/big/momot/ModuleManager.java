...
public class ModuleManager {
	...
	public <T extends Object> T nextParameterValue(Parameter parameter, Class<T> valueType) {
	...
	public <T extends Object> T nextParameterValue(String qualifiedParameterName, Class<T> valueType) {
		return nextParameterValue(getParameter(qualifiedParameterName), valueType);
	}
	
	public Object nextParameterValue(String qualifiedUnitName, String parameterName) {
		return nextParameterValue(getParameter(qualifiedUnitName, parameterName));
	}
	
	public <T extends Object> T nextParameterValue(String qualifiedUnitName, String parameterName, Class<T> valueType) {
		return nextParameterValue(getParameter(qualifiedUnitName, parameterName), valueType);
	}
	
	public Object nextParameterValue(String moduleName, String unitName, String parameterName) {
		return nextParameterValue(getParameter(moduleName, unitName, parameterName));
	}
	
	public <T extends Object> T nextParameterValue(String moduleName, String unitName, String parameterName, Class<T> valueType) {
	...
	public <T extends Assignment> T assignParameterValues(T assignment) {
		...
		for(Parameter parameter : assignment.getUnit().getParameters()) {
			Object value = nextParameterValue(parameter);
			if(value != null)
