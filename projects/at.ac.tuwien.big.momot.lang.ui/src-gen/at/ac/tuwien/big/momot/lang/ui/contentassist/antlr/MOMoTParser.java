		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getResultManagementAccess().getAlternatives_3(), "rule__ResultManagement__Alternatives_3");
					...
					put(grammarAccess.getTransformationOrchestrationAccess().getGroup(), "rule__TransformationOrchestration__Group__0");
					put(grammarAccess.getTransformationOrchestrationAccess().getGroup_4(), "rule__TransformationOrchestration__Group_4__0");
					put(grammarAccess.getTransformationOrchestrationAccess().getGroup_5(), "rule__TransformationOrchestration__Group_5__0");
					put(grammarAccess.getTransformationOrchestrationAccess().getGroup_6(), "rule__TransformationOrchestration__Group_6__0");
					...
					put(grammarAccess.getAnalysisOrchestrationAccess().getGroup(), "rule__AnalysisOrchestration__Group__0");
					put(grammarAccess.getAnalysisOrchestrationAccess().getGroup_10(), "rule__AnalysisOrchestration__Group_10__0");
					...
					put(grammarAccess.getSaveObjectivesCommandAccess().getGroup(), "rule__SaveObjectivesCommand__Group__0");
					put(grammarAccess.getSaveSolutionsCommandAccess().getGroup(), "rule__SaveSolutionsCommand__Group__0");
					put(grammarAccess.getPrintObjectivesCommandAccess().getGroup(), "rule__PrintObjectivesCommand__Group__0");
					put(grammarAccess.getPrintSolutionsCommandAccess().getGroup(), "rule__PrintSolutionsCommand__Group__0");
					...
					put(grammarAccess.getTransformationOrchestrationAccess().getModulesAssignment_3(), "rule__TransformationOrchestration__ModulesAssignment_3");
					put(grammarAccess.getTransformationOrchestrationAccess().getUnitsToRemoveAssignment_4_2(), "rule__TransformationOrchestration__UnitsToRemoveAssignment_4_2");
					put(grammarAccess.getTransformationOrchestrationAccess().getNonSolutionParametersAssignment_5_2(), "rule__TransformationOrchestration__NonSolutionParametersAssignment_5_2");
					put(grammarAccess.getTransformationOrchestrationAccess().getParameterValuesAssignment_6_3(), "rule__TransformationOrchestration__ParameterValuesAssignment_6_3");
					...
					put(grammarAccess.getSearchOrchestrationAccess().getTransformationOrchestrationAssignment_10(), "rule__SearchOrchestration__TransformationOrchestrationAssignment_10");
					...
					put(grammarAccess.getAnalysisOrchestrationAccess().getIndicatorsAssignment_3(), "rule__AnalysisOrchestration__IndicatorsAssignment_3");
					put(grammarAccess.getAnalysisOrchestrationAccess().getSignificanceAssignment_6(), "rule__AnalysisOrchestration__SignificanceAssignment_6");
					put(grammarAccess.getAnalysisOrchestrationAccess().getShowAssignment_9(), "rule__AnalysisOrchestration__ShowAssignment_9");
					put(grammarAccess.getAnalysisOrchestrationAccess().getGroupingAssignment_10_2(), "rule__AnalysisOrchestration__GroupingAssignment_10_2");
					...
					put(grammarAccess.getResultManagementAccess().getSaveAnalysisAssignment_2(), "rule__ResultManagement__SaveAnalysisAssignment_2");
					put(grammarAccess.getResultManagementAccess().getSaveObjectivesAssignment_3_0(), "rule__ResultManagement__SaveObjectivesAssignment_3_0");
					put(grammarAccess.getResultManagementAccess().getSaveSolutionsAssignment_3_1(), "rule__ResultManagement__SaveSolutionsAssignment_3_1");
					put(grammarAccess.getResultManagementAccess().getPrintObjectivesAssignment_3_2(), "rule__ResultManagement__PrintObjectivesAssignment_3_2");
					put(grammarAccess.getResultManagementAccess().getPrintSolutionsAssignment_3_3(), "rule__ResultManagement__PrintSolutionsAssignment_3_3");
					put(grammarAccess.getResultManagementAccess().getDoCommandAssignment_4(), "rule__ResultManagement__DoCommandAssignment_4");
					put(grammarAccess.getSaveAnalysisCommandAccess().getFileAssignment_1(), "rule__SaveAnalysisCommand__FileAssignment_1");
					put(grammarAccess.getSaveObjectivesCommandAccess().getAlgorithmsAssignment_1(), "rule__SaveObjectivesCommand__AlgorithmsAssignment_1");
					put(grammarAccess.getSaveObjectivesCommandAccess().getFileAssignment_2(), "rule__SaveObjectivesCommand__FileAssignment_2");
					put(grammarAccess.getSaveSolutionsCommandAccess().getAlgorithmsAssignment_1(), "rule__SaveSolutionsCommand__AlgorithmsAssignment_1");
					put(grammarAccess.getSaveSolutionsCommandAccess().getDirectoryAssignment_2(), "rule__SaveSolutionsCommand__DirectoryAssignment_2");
					put(grammarAccess.getPrintObjectivesCommandAccess().getAlgorithmsAssignment_2(), "rule__PrintObjectivesCommand__AlgorithmsAssignment_2");
					put(grammarAccess.getPrintSolutionsCommandAccess().getAlgorithmsAssignment_2(), "rule__PrintSolutionsCommand__AlgorithmsAssignment_2");
