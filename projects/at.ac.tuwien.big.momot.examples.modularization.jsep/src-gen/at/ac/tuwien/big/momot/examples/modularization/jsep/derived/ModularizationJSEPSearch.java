...
import at.ac.tuwien.big.momot.examples.modularization.jsep.ModularizationCalculator;
import at.ac.tuwien.big.momot.examples.modularization.jsep.ModularizationRules;
...
public class ModularizationJSEPSearch {
  ...
  public class ModularizationJSEPFitnessFunction extends EGraphMultiDimensionalFitnessFunction {
    ...
    protected void preprocessEvaluation(final TransformationSolution solution) {
      ...
      solution.setAttribute(ModularizationJSEPSearch.attribute, _modularizationCalculator);
    }
  }
  ...
  protected double _createObjectiveHelper_0(final TransformationSolution solution, final EObject root) {
    ...
    {
      final ModularizationCalculator calculator = solution.<ModularizationCalculator>getAttribute(ModularizationJSEPSearch.attribute, ModularizationCalculator.class);
  ...
  protected double _createConstraintHelper_0(final TransformationSolution solution, final EObject root) {
    ...
    return (ModularizationJSEPSearch.penalty * _size);
  }
  ...
  protected IEGraphMultiDimensionalFitnessFunction createFitnessFunction(final TransformationSearchOrchestration orchestration) {
    IEGraphMultiDimensionalFitnessFunction function = new ModularizationJSEPSearch.ModularizationJSEPFitnessFunction();
  ...
  protected TransformationResultManager handleResults(final SearchExperiment experiment) {
    ...
    resultManager.saveApproximationSetObjectives("data/output/approximationSet/mtunis_eca.pf");
    resultManager.setBaseDirectory("data/output/models/mtunis_eca/");
  ...
  public static void main(final String... args) {
    init();
    ModularizationJSEPSearch search = new ModularizationJSEPSearch();
