...
public class ArchitecturePackageImpl extends EPackageImpl implements ArchitecturePackage {
	 ...
	 * @see at.ac.tuwien.big.momot.examples.modularization.jsep.architecture.ArchitecturePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getSoftwareModel_Classes() {
	 ...
	 * @generated
	 */
	public EReference getSoftwareModel_Features() {
	 ...
	 * @generated
	 */
	public EReference getFeature_Container() {
	...
	public void createPackageContents() {
		...
		createEReference(softwareModelEClass, SOFTWARE_MODEL__CLASSES);
		createEReference(softwareModelEClass, SOFTWARE_MODEL__FEATURES);

		classEClass = createEClass(CLASS);
		createEReference(classEClass, CLASS__FEATURES);

		featureEClass = createEClass(FEATURE);
		createEReference(featureEClass, FEATURE__CONTAINER);
	...
	public void initializePackageContents() {
		...
		softwareModelEClass.getESuperTypes().add(this.getNamedElement());
		...
		initEReference(getSoftwareModel_Classes(), this.getClass_(), null, "classes", null, 0, -1, SoftwareModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSoftwareModel_Features(), this.getFeature(), null, "features", null, 0, -1, SoftwareModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(classEClass, at.ac.tuwien.big.momot.examples.modularization.jsep.architecture.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_Features(), this.getFeature(), this.getFeature_Container(), "features", null, 1, -1, at.ac.tuwien.big.momot.examples.modularization.jsep.architecture.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(featureEClass, Feature.class, "Feature", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFeature_Container(), this.getClass_(), this.getClass_Features(), "container", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
