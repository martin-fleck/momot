...
public class ArchitectureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ArchitecturePackage.SOFTWARE_MODEL: {
				SoftwareModel softwareModel = (SoftwareModel)theEObject;
				T result = caseSoftwareModel(softwareModel);
				if (result == null) result = caseNamedElement(softwareModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitecturePackage.CLASS: {
				at.ac.tuwien.big.momot.examples.modularization.jsep.architecture.Class class_ = (at.ac.tuwien.big.momot.examples.modularization.jsep.architecture.Class)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(at.ac.tuwien.big.momot.examples.modularization.jsep.architecture.Class object) {
		return null;
	}
