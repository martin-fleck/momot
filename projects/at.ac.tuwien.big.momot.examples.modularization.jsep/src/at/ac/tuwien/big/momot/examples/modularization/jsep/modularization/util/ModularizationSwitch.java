...
public class ModularizationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModularizationPackage.CLASS: {
				at.ac.tuwien.big.momot.examples.modularization.jsep.modularization.Class class_ = (at.ac.tuwien.big.momot.examples.modularization.jsep.modularization.Class)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(at.ac.tuwien.big.momot.examples.modularization.jsep.modularization.Class object) {
		return null;
	}
