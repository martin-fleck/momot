...
import at.ac.tuwien.big.momot.examples.modularization.jsep.modularization.ModularizationFactory;
...
import at.ac.tuwien.big.momot.examples.modularization.jsep.modularization.NamedElement;
...
public class ModularizationPackageImpl extends EPackageImpl implements ModularizationPackage {
	 ...
	 * @see at.ac.tuwien.big.momot.examples.modularization.jsep.modularization.ModularizationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(classEClass, at.ac.tuwien.big.momot.examples.modularization.jsep.modularization.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_Module(), this.getModule(), this.getModule_Classes(), "module", null, 0, 1, at.ac.tuwien.big.momot.examples.modularization.jsep.modularization.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_DependsOn(), this.getClass_(), this.getClass_DependedOnBy(), "dependsOn", null, 0, -1, at.ac.tuwien.big.momot.examples.modularization.jsep.modularization.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_DependedOnBy(), this.getClass_(), this.getClass_DependsOn(), "dependedOnBy", null, 0, -1, at.ac.tuwien.big.momot.examples.modularization.jsep.modularization.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
